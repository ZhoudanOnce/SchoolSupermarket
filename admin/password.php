<?php 
	...
	$tb_name = "admin";
	$rs = $mysql->db_get_row("select * from $tb_name where id=".$_SESSION["adminid"]);
	if ($_POST){
		$row = $mysql->db_get_row("select * from $tb_name where id=".$_SESSION["adminid"]);
		if($_POST["password"] != $_POST["repassword"]) {
			...
			if($_POST["aname"]){$data["aname"] = "'".$_POST["aname"]."'";}
