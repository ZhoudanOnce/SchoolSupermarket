	...
	<tr>
		...
		<td valign="top">
			<table width="100%" height="31" border="0" cellpadding="0" cellspacing="0">
				<tr bgcolor="#FFFFFF"><td height="31"><div class="title">添加/修改员工</div></td></tr>
			</table>
		</td>
						  ...
						  <td colspan="2">
								<form name="form1" method="post" action="?" onSubmit="return check()"  enctype="multipart/form-data">
                                    ...
                                    <table width="100%" class="cont">
                                        ...
                                        <?php }?>
										<tr>
                                          <td width="120" align="right"><span class="red">*</span> 工号：</td>
                                          <td width=""><input class="text" name="username" type="text" maxlength="18" value="<?php echo $rs["username"];?>" <?php if($rs["id"]){echo "readonly";}?>></td>
                                        </tr>
                                        <tr>
                                          <td align="right">密码：</td>
                                          <td><input name="password" type="password" class="text" size="30"  maxlength="20">
                                            <?php if($_REQUEST["id"]){ echo "不修改请留空";} ?>
                                          </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                          <td width="120" align="right"><span class="red">*</span> 婚姻状况：</td>
                                          <td width="">
                                          	<select name="hun">
                                       ...
                                       <tr>
                                          <td width="120" align="right">住址：</td>
                                          <td width=""><input name="zhuzhi" type="text" class="text" size="30"  maxlength="50" value="<?php echo $rs["zhuzhi"];?>" required></td>
                                        </tr>
                                        <tr>
                                          <td width="120" align="right">入职时间：</td>
                                          <td width=""><script language="javascript" type="text/javascript" src="../../My97DatePicker/WdatePicker.js"></script>     
