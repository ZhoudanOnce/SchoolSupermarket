<?php 
	...
	$tb_name = "menu";
	$where_sql = "pid=0 and isno=0 and type=0 and auth=".$_REQUEST['auth'];
	...
	if ($_POST){
		...
		urlMsg("操作完成", $tb_name."_list.php?auth=".$_POST["auth"]);
	}
...
<?php
	if ($_REQUEST["act"]=="del") {
		...
		urlMsg("操作成功", $tb_name."_list.php?auth=".$_REQUEST['auth']);
	}
?>
</body>
</html>