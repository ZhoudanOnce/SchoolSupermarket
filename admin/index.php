	...
	<div id="hd">
    	<div class="hd-wrap ue-clear">
            ...
            <div class="login-info ue-clear">
                <div class="welcome ue-clear"><span>欢迎您,</span><a href="javascript:void(0)" class="user-name"><?php echo $_SESSION['adminname'];?></a></div>
            </div>
    	...
    	<div class="wrap ue-clear">
        	<div class="sidebar">
                ...
                <ul class="nav">
                    ...
                    <?php $i = 1;$class_art = $mysql->db_get_all("select * from menu where pid=0 and isno=0 and type=0 and auth=1 order by grade asc limit 12");foreach($class_art as $row4) {?>
