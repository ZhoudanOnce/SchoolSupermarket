	...
	<tr>
		...
		<td valign="top">
			<table width="100%" height="31" border="0" cellpadding="0" cellspacing="0">
				<tr bgcolor="#FFFFFF"><td height="31"><div class="title">添加/修改片区</div></td></tr>
			</table>
		</td>
								...
								<input type="hidden" name="id" value="<?php echo $rs["id"];?>" />
                                    <table width="100%" class="cont">
                                        ...
                                        <tr>
                                          ...
                                          <td width=""><input name="mark" type="text" class="text" size="30" value="<?php echo $rs["mark"];?>"></td>
                                        </tr>
                                        <tr>
                                          <td width="" align="right">地址：</td>
                                          <td width=""><input name="address" type="text" class="text" size="30" value="<?php echo $rs["address"];?>"></td>
                                        </tr>
                                        <tr>
                                            <td align="right">&nbsp;</td>
