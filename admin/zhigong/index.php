	...
	<div id="hd">
    	<div class="hd-wrap ue-clear">
            ...
            <div class="login-info ue-clear">
                <div class="welcome ue-clear"><span>欢迎您,</span><a href="javascript:void(0)" class="user-name"><?php echo $_SESSION['zhigongzname'];?></a></div>
            </div>
            <div class="toolbar ue-clear">
				<a  class="home-btn"><?php echo "今天是 " . date("Y-m-d");?></a>
                <a href="<?php echo __BASE__;?>/index.php" target="_blank" class="home-btn">首页</a>
                <a href="password.php"  target="right" class="home-btn">修改密码</a>
    	...
    	<div class="wrap ue-clear">
        	<div class="sidebar">
                ...
                <ul class="nav">
                    ...
                    <?php $i = 1;$class_art = $mysql->db_get_all("select * from menu where pid=0 and isno=0 and type=0 and auth=2 order by grade asc limit 12");foreach($class_art as $row4) {?>
